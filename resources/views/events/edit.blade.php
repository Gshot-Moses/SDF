            ...
            <div class="col-6 card-body bg-light">
                <form action="{{ route('event.update', $event->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" placeholder="Titre de l'evenement" class="form-control" value="{{ $event->name }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" name="start_time" id="start-time" class="form-control" value="{{ $start_time }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" name="end_time" id="end-time" class="form-control" value="{{ $end_time }}">
                    </div>
        
                    <div class="form-group">
                        <textarea placeholder="Les details de l'evenement" name="details" class="form-control" value="{{ $event->details }}"></textarea>
                    </div>
